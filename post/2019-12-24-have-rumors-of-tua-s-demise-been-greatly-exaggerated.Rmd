...
stock %>%
    ...
    geom_jitter() +
    scale_y_reverse(breaks = c(16, 10, 5, 1), limits = c(16, 0)) +
...
My plans are to continue to collect mock drafts as the draft season progresses and to write more about what I hope are interesting topics using mock draft data. If you are interested in chatting more about this type of work or have interesting ideas for future blog posts, please do not hesitate to reach out to me here or on [Twitter](https://twitter.com/benj_robinson) or using the [#GrindingtheMocks hashtag](https://twitter.com/search?q=%23GrindingtheMocks)!
